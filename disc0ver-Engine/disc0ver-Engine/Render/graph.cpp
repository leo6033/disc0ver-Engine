...
void disc0ver::Model::scale()
{
	...
	float  m_scale = 100;
	m_scale = m_scale < (1.0 / (max_x - min_x)) ? m_scale : (1.0 / (max_x - min_x));//�Ƚϳ����ű��� ����¼С�ı���ֵ
	m_scale = m_scale < (1.0 / (max_y - min_y)) ? m_scale : (1.0 / (max_y - min_y));//�ȽϿ����ű��� ����¼С�ı���ֵ
	m_scale = m_scale < (1.0 / (max_z - min_z)) ? m_scale : (1.0 / (max_z - min_z));//�Ƚϸ����ű��� ����¼С�ı���ֵ
